...
from training.zeroshot_classification import evaluate_long_context
...
from training.train import train_one_epoch, evaluate, evaluate_zeroshot, train_one_epoch_clip_attributes_cosine
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if any(v in data for v in ('val', 'imagenet-val', 'imagenet-v2')):
            if args.rank==0 and epoch%5==0:
                # best_model_so_far ="/home/username/open_clip/saved_models/clip_finetuned_captions/model_britmus_finetuned_captions.pt"
                ...
                # current_metric = metrics[f'val_{key}_mean_average_precision']
                ...
                # save_path="/home/username/open_clip/saved_models/clip_finetuned_captions/"
                # best_model_so_far ="/home/username/open_clip/saved_models/clip_finetuned_captions/model_vamus_finetuned_captions.pt"
                ...
                if current_metric > maxx_metric:
                    ...
                    save_path=f"/home/username/open_clip/saved_models/clip_finetuned_captions_final_attr/{args.supreme_key}/"
    ...
    if 'test' in data and args.rank == 0:
        ...
        for key in classnames.keys():
            ...
            if key in ["key","image_path","caption","object_id","Museum number"]:
                continue
            metrics, all_image_features = evaluate_long_context(
                model, 
                data["test_clip_context"][key].dataloader, 
                tokenizer, 
                classnames[key],key=key, templates=None, 
                device="cuda", 
        ...
        #     metrics, all_image_features = evaluate_long_context(
        #         model, 
        #         data["val_clip_context"][key].dataloader, 
        #         tokenizer, 
        #         classnames[key],key=key, templates=None, 
        #         device="cuda", 
