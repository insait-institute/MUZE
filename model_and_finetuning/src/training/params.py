...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="json with classes acc zeroshot",
    )
    parser.add_argument(
        "--train-num-samples",
        type=int,
    ...
    parser.add_argument(
        "--supreme-key", default="materials", type=str, help="class=key from dataset"
    )
    parser.add_argument(
        "--wandb_project_name", default="museum-tabdata-test", type=str, help="class=key from dataset"
    )
    parser.add_argument(
        "--report-to",
        default='',
