...
python -u /home/username/open_clip_original/src/training/main_lora_zeroshotclassif_transformer.py \
    ...
    --supreme-key "$1" \
    --include-context \
    --exp-name "vamus_${1}_transformer_vis" \
    --group "vamus_transformer_1e-4_archit${2}_vis"\
    --head-architecture $2 \
    --lora-rank 32 \
    --lora-alpha 1.0 \
    --lora-dropout 0.0 \
    ...
    --val-data "/home/username/open_clip/finetuning/val_va_dataset_new.csv" \
    ...
    --precision fp16 \
    --classes "/home/username/open_clip/finetuning/va_classes_new.json" \
