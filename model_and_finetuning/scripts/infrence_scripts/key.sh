...
python -u /home/username/open_clip_original/src/training/main_lora_zeroshotclassif_transformer.py \
    --supreme-key $1 \
    --exp-name "${3}_${1}_transformer" \
    --group "${3}_transformer_1e-4_archit${2}_nocontext_27feb"\
    --head-architecture $2 \
    --lora-rank 32 \
    --lora-alpha 1.0 \
    --lora-dropout 0.0 \
    ...
    --dataset-type csv \
    --train-data "/home/username/open_clip/finetuning/dataset_splits/${3}_train.csv" \
    --val-data "/home/username/open_clip/finetuning/dataset_splits/${3}_val.csv" \
    ...
    --precision fp16 \
    --classes "/home/username/open_clip/finetuning/${3}_classes.json" \
